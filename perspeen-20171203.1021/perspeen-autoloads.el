...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "perspeen" '("perspeen-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "perspeen-tab" '("perspeen-tab-")))
